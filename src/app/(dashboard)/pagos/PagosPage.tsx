              ...
              <Stack spacing={2}>
                <Stack direction={{ xs: 'column', md: 'row' }} spacing={2} alignItems="center">
                  ...
                  <Stack direction="row" spacing={1} sx={{ width: { xs: '100%', md: 'auto' } }}>
                    ...
                    {(filters.senseiFilter !== 'all' || filters.categoriaFilter !== 'all' || filters.clubFilter !== 'all' || filters.statusFilter !== 'all' || searchTerm !== '') && (
                  ...
                  >
                    ...
                    <FormControl size="small" sx={{ minWidth: 200, backgroundColor: 'white', flexGrow: { xs: 1, md: 0 } }}>
                      ...
                      <Select
                        ...
                        onChange={(e) => filters.setStatusFilter(e.target.value as any)}
                      >
                  ...
                  <TableBody>
                    {paginatedJudokas.map((judoka, index) => {
                      ...
                      const rowColor = status === 'vencido' 
                        ...
                        : status === 'pendiente'
                        ? 'rgba(237, 108, 2, 0.08)' // Naranja/Amarillo suave
                        : 'inherit'
